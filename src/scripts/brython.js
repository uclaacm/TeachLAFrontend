...
// implementation [3, 6, 2, 'final', 0]
// version compiled from commented, indented source files at
// github.com/brython-dev/brython
!(function(r, n) {
  "use strict";
  function t(r, n, t, e) {
    for (t = void 0 !== t ? t : 0, e = void 0 !== e ? e : r.length; e > t; ) {
      var c = (e + t) >> 1;
      r[c] > n ? (e = c) : (t = c + 1);
    }
    return t;
  ...
  function a(r) {
    var n;
    return (
      r >= 1114112 ? (n = 0) : ((n = e(r >> J)), (n = c((n << J) + (r & ((1 << J) - 1))))), y[n]
    );
  }
  function i(r, n) {
    for (var t = "", e = 0; n > e; e++) t += String.fromCharCode(I[r + e]);
    return t;
  }
  function o(r) {
  ...
  function m(r) {
    var n = r.charCodeAt(0),
      t = a(n);
    return t[H] & rn ? i(65535 & t[D], t[D] >> 24) : String.fromCharCode(n + t[D]);
  }
  function S(r) {
    var n = r.charCodeAt(0),
      t = a(n);
    return t[H] & rn ? i(65535 & t[E], t[E] >> 24) : String.fromCharCode(n + t[E]);
  }
  function w(r) {
    var n = r.charCodeAt(0),
      t = a(n);
    return t[H] & rn ? i(65535 & t[B], t[B] >> 24) : String.fromCharCode(n + t[B]);
  }
  function b(r) {
    var n = r.charCodeAt(0),
      t = a(n);
    if (t[H] & rn && (t[D] >> 20) & 7) {
      var e = (65535 & t[D]) + (t[D] >> 24),
        c = (t[D] >> 20) & 7;
      return i(e, c);
    }
    return m(r);
  ...
  function k(r) {
    return j(r) || s(r) || A(r) || l(r);
  }
  function q(r, n) {
    var t, e;
    for (t = n - 1; t >= 0 && ((e = r.charAt(t)), _(e)); t--);
    var c = t >= 0 && z(e);
    if (c) {
      for (t = n + 1; r.length > t && ((e = r.charAt(t)), _(e)); t++);
      c = t == r.length || !z(e);
    }
    return String.fromCharCode(c ? 962 : 963);
  }
  function x(r, n, t) {
    return 931 == r.charCodeAt(0) ? q(n, t) : m(r);
  }
  n.unicode = r;
  var y = [
      [0, 0, 0, 0, 0, 0],
    ...
    rn = 16384;
  (unicode = unicode || {}),
    (unicode.title = function(r) {
      for (var n = "", t = !1, e = 0; r.length > e; e++) {
        var c = r.charAt(e);
        (n += t ? x(c, r, e) : S(c)), (t = z(c));
      }
      return n;
    }),
    (unicode.capitalize = function(r) {
      var n = "";
      n += w(r.charAt(0));
      for (var t = 1; r.length > t; t++) n += x(r.charAt(t), r, t);
      return n;
    }),
    (unicode.casefold = function(r) {
      for (var n = "", t = 0; r.length > t; t++) n += b(r.charAt(t));
      return n;
    }),
    (unicode.islower = function(r) {
      if ("" == r) return !1;
      for (var n = !1, t = 0; r.length > t; t++) {
        var e = r.charAt(t);
        if (p(e) || o(e)) return !1;
        n || (n = g(e));
      }
    ...
    (unicode.istitle = function(r) {
      if ("" == r) return !1;
      for (var n = !1, t = !1, e = 0; r.length > e; e++) {
        var c = r.charAt(e);
        if (p(c) || o(c)) {
          if (t) return !1;
          (t = !0), (n = !0);
    ...
    (unicode.isidentifier = function(r) {
      if ("" == r) return !1;
      if ("_" != r.charAt(0) && !f(r.charAt(0))) return !1;
      for (var n = 1; r.length > n; n++) if (!h(r.charAt(n))) return !1;
      return !0;
    }),
    (unicode.isprintable = function(r) {
      for (var n = 0; r.length > n; n++) if (!C(r.charAt(n))) return !1;
      return !0;
    }),
    (unicode.lower = function(r) {
      for (var n = "", t = 0; r.length > t; t++) {
        var e = r.charAt(t);
        n += x(e, r, t);
      }
      return n;
    }),
    (unicode.swapcase = function(r) {
      for (var n = "", t = 0; r.length > t; t++) {
        var e = r.charAt(t);
        n += p(e) ? x(e, r, t) : g(e) ? w(e) : e;
      }
      return n;
    }),
    (unicode.upper = function(r) {
      for (var n = "", t = 0; r.length > t; t++) {
        var e = r.charAt(t);
        n += w(e);
      }
...
(function($B) {
  ...
  var $_SyntaxError = ($B.parser.$_SyntaxError = function(C, msg, indent) {
    ...
    if (indent === undefined) {
      if (Array.isArray(msg)) {
        $B.$SyntaxError(module, msg[0], $pos, line_num);
      }
      ...
      throw $B.$IndentationError(module, msg, $pos);
    }
  });
  ...
  var $YieldFromMarkerNode = ($B.parser.$YieldFromMarkerNode = function(params) {
    ...
    this.transform = function(rank) {
      ...
      if (params.save_result) {
        ...
        var new_node = add_jscode(
          this.parent,
          params.save_result_rank + rank + 1,
          assign_ctx.to_js(),
        );
      }
      return 2;
    ...
    if (C.type == "expr" && C.tree[0].type == "call") {
      ...
      if (assigned && assigned.type == "id") {
        if (noassign[assigned.value] === true) {
          $_SyntaxError(C, ["can't assign to keyword"]);
        }
        assigned.bound = true;
        if (!$B._globals[scope.id] || $B._globals[scope.id][assigned.value] === undefined) {
        ...
        $_SyntaxError(C, ["can't assign to literal"]);
      }
    }
    ...
    this.transform = function(node, rank) {
      ...
      switch (left.type) {
        case "expr":
          if (left.tree.length > 1) {
            ...
            if ($B._globals && $B._globals[scope.id] && $B._globals[scope.id][name]) {
            } else {
      ...
      if (right_items !== null) {
        if (right_items.length > left_items.length) {
          throw Error(
            "ValueError : too many values to unpack (expected " + left_items.length + ")",
          );
    ...
    this.to_js = function() {
      ...
      if (left.type == "attribute" || left.type == "sub") {
        ...
        if (
          ...
          ("eval" == right.tree[0].func.value || "exec" == right.tree[0].func.value)
        ) {
  ...
  var $AugmentedAssignCtx = ($B.parser.$AugmentedAssignCtx = function(C, op) {
    ...
    this.transform = function(node, rank) {
      ...
      aa2.add($NodeJS(left + " = $B.$getattr(" + C.to_js() + ',"' + func + '")(' + right + ")"));
  ...
  var $ClassCtx = ($B.parser.$ClassCtx = function(C) {
    ...
    this.transform = function(node, rank) {
      ...
      var module_name = "$locals_" + $get_module(this).module.replace(/\./g, "_") + ".__name__";
      rank++;
      node.parent.insert(
        rank + 1,
  ...
  var $DefCtx = ($B.parser.$DefCtx = function(C) {
    ...
    this.set_name = function(name) {
      ...
      this.binding = {};
      if (
        $B._globals[this.scope.id] !== undefined &&
    ...
    this.transform = function(node, rank) {
      ...
      if ($B.profile > 1) {
        if (this.scope.ntype == "class") {
          fname = this.scope.C.tree[0].name + "." + this.name;
        } else {
          fname = this.name;
        }
        if (pnode && pnode.id) {
      ...
      if (
        ...
        if ($B.debug > 0) {
          js = "if($len !=" + pos_len + '){$B.wrong_nb_args("' + this.name + '", $len, ' + pos_len;
        ...
        if (this.positional_list.length > 0) {
          if (this.type == "generator") {
            ...
            if ($B.debug < 1) {
              js =
                "if($len !=" + pos_len + '){$B.wrong_nb_args("' + this.name + '", $len, ' + pos_len;
              if (positional_str.length > 0) {
                js += ", [" + positional_str + "]";
              }
              js += ")}";
      ...
      node.parent.insert(
        rank + offset++,
        $NodeJS("    __defaults__ : [" + def_names.join(", ") + "],"),
      );
      ...
      if (this.type == "def") {
        ...
        if (this.async) {
          node.parent.insert(rank + offset++, $NodeJS(prefix + " = $B.make_async(" + prefix + ")"));
        }
      }
      if (this.type == "def") {
        var parent = node;
        for (
          var pos = 0;
          pos < parent.children.length && parent.children[pos] !== $B.last(enter_frame_nodes);
          pos++
        ) {}
    ...
    this.to_js = function() {
      ...
      switch (this.real) {
        case "dict":
          ...
          if (packed.length > 0) {
            return "dict.$factory(" + this.unpack_dict(packed) + ")" + $to_js(this.tree);
          }
          var res = [];
  ...
  var $ForExpr = ($B.parser.$ForExpr = function(C) {
    ...
    this.transform = function(node, rank) {
      ...
      if ($range && scope.ntype != "generator") {
        ...
        for_node.add(
          $NodeJS("if($safe" + num + " && $next" + num + ">= $stop_" + num + "){break}"),
        );
        for_node.add(
          $NodeJS(
            "else if(!$safe" + num + " && $B.ge($next" + num + ", $stop_" + num + ")){break}",
          ),
        );
        ...
        for_node.add(
          $NodeJS('$locals.$line_info = "' + node.line_num + "," + scope.id + '"; None;'),
        );
        var in_loop = false;
        if (scope.ntype == "module") {
      ...
      while_node.add(
        $NodeJS(
          "if($locals.$len" +
            ...
            "!=$locals.$len_func" +
            num +
            '()){throw RuntimeError.$factory("dictionary' +
  ...
  var $IdCtx = ($B.parser.$IdCtx = function(C, value) {
    ...
    this.to_js = function(arg) {
      ...
      this.unbound =
        this.unbound ||
        (is_local && !this.bound && bound_before && bound_before.indexOf(val) == -1);
      if (
        !this.bound &&
        this.scope.C &&
      ...
      while (1) {
        if ($B._globals[scope.id] !== undefined && $B._globals[scope.id][val] !== undefined) {
  ...
  var $ImportCtx = ($B.parser.$ImportCtx = function(C) {
    ...
    this.to_js = function() {
      ...
      this.tree.forEach(function(item) {
        ...
        res.push('$B.$import("' + mod_name + '", [],' + aliases + "," + localns + ", true);");
      });
          ...
          for (var i = 1; i < this.intervals.length; i++) {
            ...
            comments.forEach(function(comment) {
              if (comment[0] > start && comment[0] < end) {
                ...
                txt = txt.substr(0, pos) + txt.substr(pos + comment[1] + 1);
              }
            });
            items.push(txt);
            var lines = txt.split("\n");
  ...
  var $NonlocalCtx = ($B.parser.$NonlocalCtx = function(C) {
    ...
    this.transform = function(node, rank) {
      ...
      if (pscope.C === undefined) {
        $_SyntaxError(C, [
          "no binding for nonlocal '" + $B.last(Object.keys(this.names)) + "' found",
        ]);
      } else {
      ...
      if (this.token == "finally") {
        ...
        if (scope.ntype != "generator") {
          ...
          if (last_child.C.tree[0].type != "return") {
            add_jscode(node, -1, 'if($exit){$B.leave_frame("' + scope_id + '")}');
          }
        }
      }
    };
    ...
    this.to_js = function() {
      ...
      for (var i = 0; i < this.tree.length; i++) {
        if (this.tree[i].type == "call") {
          var js =
            '(function(){throw TypeError.$factory("' + "'str'" + ' object is not callable")}())';
          return js;
        } else {
  ...
  var $TryCtx = ($B.parser.$TryCtx = function(C) {
    ...
    this.transform = function(node, rank) {
      ...
      add_jscode(
        catch_node,
        0,
        "var " + failed_name + " = true;" + "$B.pmframe = $B.last($B.frames_stack);" + "if(0){}",
      );
      var pos = rank + 2;
  ...
  var $add_line_num = ($B.parser.$add_line_num = function(node, rank) {
    if (node.type == "module") {
      ...
      if ((elt.type == "condition" && elt.token == "while") || node.C.type == "for") {
        if ($B.last(node.children).C.tree[0].type != "return") {
          node.add($NodeJS('$locals.$line_info = "' + node.line_num + "," + mod_id + '";'));
        }
      }
      return offset;
    } else {
  ...
  var $get_docstring = ($B.parser.$get_docstring = function(node) {
    ...
    if (node.children.length > 0) {
      ...
      if (
        firstchild.C.tree &&
        firstchild.C.tree.length > 0 &&
        firstchild.C.tree[0].type == "expr"
      ) {
    ...
    switch (C.type) {
      case "abstract_expr":
        ...
        switch (token) {
          ...
          case ":":
            if (
              C.parent.type == "sub" ||
              (C.parent.type == "list_or_tuple" && C.parent.parent.type == "sub")
            ) {
          ...
          case ")":
            if (
              ...
              ["kwarg", "star_arg", "double_star_arg"].indexOf(
                $B.last(C.parent.tree).tree[0].type,
              ) == -1
            ) {
        ...
        switch (token) {
          ...
          case "=":
            if (C.expect == ",") {
              ...
              } else if (C.parent.type == "annotation") {
      ...
      case "func_args":
        switch (token) {
          ...
          case ",":
            if (C.has_kw_arg) {
              $_SyntaxError(C, "duplicate kw arg");
            }
            if (C.expect == ",") {
              C.expect = "id";
              return C;
          ...
          case "op":
            ...
            if (op == "*") {
              if (C.has_star_arg) {
                $_SyntaxError(C, "duplicate star arg");
              }
      ...
      case "id":
        switch (token) {
          ...
          case "imaginary":
            if (C.value == "print") {
              $_SyntaxError(C, ["missing parenthesis in call to 'print'"]);
            }
            $_SyntaxError(C, "token " + token + " after " + C);
        }
        if (C.value == "async") {
      ...
      case "lambda":
        ...
        if (C.args === undefined) {
          return $transition(new $CallCtx(C), token, value);
        }
        $_SyntaxError(C, "token " + token + " after " + C);
      case "list_or_tuple":
        if (C.closed) {
  ...
  var $tokenize = ($B.parser.$tokenize = function(root, src) {
      ...
      switch (car) {
        ...
        case ".":
          if (pos < src.length - 1 && /^\d$/.test(src.charAt(pos + 1))) {
            var j = pos + 1;
            while (j < src.length && src.charAt(j).search(/\d|e|E/) > -1) {
              j++;
            }
        ...
        case "9":
          ...
          if (res) {
            $pos = pos;
            if (res[2] !== undefined) {
              C = $transition(C, "imaginary", res[0].substr(0, res[0].length - 1));
            } else {
    ...
    if (C !== null && C.tree[0] && $indented.indexOf(C.tree[0].type) > -1) {
      $pos = pos - 1;
      $_SyntaxError(C, "expected an indented block", pos);
    }
  });
  ...
  $B.py2js = function(src, module, locals_id, parent_scope, line_info) {
    ...
    root.insert(offset++, $NodeJS(local_ns + '["__package__"] = ' + local_ns + '["__package__"]'));
    root.insert(
      offset++,
      $NodeJS(local_ns + '["__file__"] = "' + $B.$py_module_path[module] + '";None;\n'),
    );
    if (line_info !== undefined) {
      root.insert(offset++, $NodeJS(local_ns + '.$line = "' + line_info + '";None;\n'));
    }
    var enter_frame_pos = offset,
      js =
        ...
        '", ' +
        global_ns +
        ', "a"]; $B.frames_stack.push($top_frame); ' +
  ...
  var brython = ($B.parser.brython = function(options) {
    ...
    if (options.open !== undefined) {
      ...
      console.log(
        "DeprecationWarning: 'open' option of 'brython' " +
    ...
    if (!isWebWorker) {
      ...
      for (var i = 0, e; (e = path_links[i]); ++i) {
        ...
        if (
          href.slice(-7).toLowerCase() == ".vfs.js" &&
          (" " + e.rel + " ").indexOf(" prefetch ") != -1
        ) {
          $B.path_importer_cache[href + "/"] = $B.imported["_importlib"].VFSPathFinder.$factory(
            href,
          );
        }
    ...
    if (options.re_module !== undefined) {
      ...
      console.log(
        "DeprecationWarning: 're_module' option of 'brython' " +
          "function will be deprecated in future versions of Brython.",
      );
    }
    if ($B.$options.args) {
    ...
    if (res === undefined || res.timestamp != $B.timestamp) {
      if ($B.VFS[module] !== undefined) {
        ...
        if (ext == ".py") {
          ...
          $B.tasks.splice(0, 0, [store_precompiled, module, js, imports, is_package]);
        } else {
  ...
  $B.run_script = function(src, name) {
    ...
    try {
      var root = $B.py2js(src, name, name),
        js = root.to_js(),
        script = { js: js, name: name, src: src, url: $B.script_path };
      if ($B.debug > 1) {
        $log(js);
      }
    } catch (err) {
    ...
    if (options.ipy_id !== undefined) {
      ...
      for (var i = 0; i < $elts.length; i++) {
        ...
        if (elt.type == "text/python" || elt.type == "text/python3") {
          ...
          var $src = null;
          if (elt.src) {
            $B.tasks.push([ajax_load_script, { name: module_name, url: elt.src }]);
          } else {
  ...
  object.__getattribute__ = function(obj, attr) {
    ...
    if (res !== undefined) {
      ...
      if (attr.substr(0, 2) == "__" && attr.substr(attr.length - 2) == "__") {
        var attr1 = attr.substr(2, attr.length - 4);
        var rank = opnames.indexOf(attr1);
        if (rank > -1) {
          var rop = "__r" + opnames[rank] + "__";
          var func = function() {
            try {
...
(function($B) {
    ...
    for (var i = 0; i < bases.length; i++) {
      ...
      if (bases[i] === undefined || bases[i].__mro__ === undefined) {
        if (bases[i].__class__ === $B.JSObject) {
          ...
          bases[i].__init__.$infos = { __name__: bases[i].__name__ };
        } else {
  ...
  method.__repr__ = method.__str__ = function(self) {
    return (
      "<bound method " +
      self.$infos.__qualname__ +
      " of " +
      _b_.str.$factory(self.$infos.__self__) +
      ">"
    );
  };
  $B.method = method;
...
(function($B) {
  ...
  $B.$getitem = function(obj, item) {
    ...
    if ((Array.isArray(obj) || typeof obj == "string") && typeof item == "number") {
      item = item >= 0 ? item : obj.length + item;
      if (obj[item] !== undefined) {
        return obj[item];
      } else {
  ...
  $B.$is_member = function(item, _set) {
    ...
    var ce = $B.current_exception;
    try {
      f = _b_.getattr(_set, "__contains__");
    } catch (err) {
      $B.current_exception = ce;
    }
    if (f) {
    ...
    try {
      f = _b_.getattr(_set, "__getitem__");
    } catch (err) {
  ...
  $B.$call = function(callable) {
    ...
    try {
      ...
      throw _b_.TypeError.$factory(
        "'" + $B.get_class(callable).__name__ + "' object is not callable",
      );
    }
  };
  ...
  $B.jsobject2pyobject = function(obj) {
    ...
    if (typeof obj === "object" && !Array.isArray(obj) && obj.__class__ === undefined) {
  ...
  $B.pyobject2jsobject = function(obj) {
    ...
    if (_b_.isinstance(obj, [_b_.int, _b_.float, _b_.str])) {
      return obj;
    }
    ...
    throw _b_.TypeError.$factory(_b_.str.$factory(obj) + " is not JSON serializable");
  };
  ...
  $B.$iterator = function(items, klass) {
    var res = {
      ...
      __next__: function() {
        res.counter++;
        if (res.counter < items.length) {
          return items[res.counter];
        }
        throw _b_.StopIteration.$factory("StopIteration");
      },
      __repr__: function() {
        return "<" + klass.__name__ + " object>";
      },
      counter: -1,
    };
  ...
  $B.$iterator_class = function(name) {
    ...
    function as_list(s) {
      return _b_.list.$factory(as_array(s));
    }
    function as_set(s) {
      return _b_.set.$factory(as_array(s));
    }
      ...
      if (klass["__" + ropnames[j] + "__"] === undefined) {
        klass["__" + ropnames[j] + "__"] = (function(name, sign) {
          return function(self, other) {
            try {
              return _b_.getattr(other, "__r" + name + "__")(self);
            } catch (err) {
  ...
  $B.$GetInt = function(value) {
    ...
    if (!value.$is_class) {
      try {
        var v = _b_.getattr(value, "__int__")();
        return v;
      } catch (e) {}
      try {
        var v = _b_.getattr(value, "__index__")();
        return v;
      } catch (e) {}
    }
    throw _b_.TypeError.$factory(
      "'" + $B.get_class(value).__name__ + "' object cannot be interpreted as an integer",
    );
  };
  $B.PyNumber_Index = function(item) {
    switch (typeof item) {
      ...
      case "object":
        ...
        if (method !== null) {
          method = typeof method == "function" ? method : _b_.getattr(method, "__call__");
          return $B.int_or_bool(method);
        }
      default:
        throw _b_.TypeError.$factory(
          "'" + $B.get_class(item).__name__ + "' object cannot be interpreted as an integer",
        );
    }
  };
    ...
    switch (typeof v) {
      ...
      case "object":
        if (v.__class__ === $B.long_int) {
          ...
          throw _b_.TypeError.$factory(
            "'" + $B.get_class(v).__name__ + "' object cannot be interpreted as an integer",
          );
        }
      default:
        throw _b_.TypeError.$factory(
  ...
  var Profile = $B.make_class("profile", function() {
    return { __class__: Profile };
  });
  ...
  $B.$profile = (function(profile) {
    ...
    var _hash = function(module, line) {
      return module + ":" + line;
    };
    ...
    var $profile = {
      ...
      count: function(module, line) {
        if (active) {
          ...
          if (!(h in profile.line_counts)) {
            profile.line_counts[h] = 0;
          }
      ...
      elapsed: function() {
        if (active) {
          return cumulated + new Date() - profile_start;
        } else {
          return cumulated;
        }
      },
      ...
      status: function() {
        ...
        if (active) {
          return "Collecting data: active";
        } else if (paused) {
          return "Collecting data: paused";
        } else {
          return "Stopped";
        }
      },
  ...
  $B.add = function(x, y) {
    ...
    if (x > min_int && x < max_int && y > min_int && y < max_int && z > min_int && z < max_int) {
      ...
      (typeof x == "number" || x.__class__ === $B.long_int) &&
...
(function($B) {
      ...
      case "lt":
        NoneType["__" + key + "__"] = (function(op) {
          return function(other) {
            throw _b_.TypeError.$factory(
              "unorderable types: NoneType() " + op + " " + $B.get_class(other).__name__ + "()",
            );
          };
        })($op);
    }
  ...
  function $builtin_base_convert_helper(obj, base) {
    ...
    if (value === undefined) {
      throw _b_.TypeError.$factory(
        "Error, argument must be an integer or" + " contains an __index__ function",
      );
    }
    if (value >= 0) {
  ...
  function compile() {
    var $ = $B.args(
      "compile",
      6,
      { source: null, filename: null, mode: null, flags: null, dont_inherit: null, optimize: null },
  ...
  function delattr(obj, attr) {
    ...
    if (typeof attr != "string") {
      throw _b_.TypeError.$factory(
        "attribute name must be string, not '" + $B.get_class(attr).__name__ + "'",
      );
    }
  ...
  function divmod(x, y) {
    ...
    return _b_.tuple.$factory([
      getattr(klass, "__floordiv__")(x, y),
  ...
  function $$eval(src, _globals, _locals) {
    ...
    if (_globals === undefined) {
      ...
      if (_globals.__class__ != _b_.dict) {
        throw _b_.TypeError.$factory(
          "exec() globals must be a dict, not " + _globals.__class__.__name__,
        );
      }
  ...
  function exec(src, globals, locals) {
    ...
    var $ = $B.args(
        "exec",
        3,
        { src: null, globals: null, locals: null },
        ["src", "globals", "locals"],
        arguments,
        { globals: missing, locals: missing },
        null,
        null,
      ),
      src = $.src,
  ...
  function format(value, format_spec) {
    ...
    throw _b_.NotImplementedError(
      "__format__ is not implemented for object '" + _b_.str.$factory(args.value) + "'",
    );
  }
  ...
  function getattr() {
    ...
    var $ = $B.args(
      "getattr",
      3,
      { obj: null, attr: null, _default: null },
      ["obj", "attr", "_default"],
      arguments,
      { _default: missing },
      null,
  ...
  function hash(obj) {
    ...
    if (hashfunc.$infos.__func__ === _b_.object.__hash__) {
      if (getattr(obj, "__eq__").$infos.__func__ !== _b_.object.__eq__) {
        throw _b_.TypeError.$factory(
          "unhashable type: '" + $B.get_class(obj).__name__ + "'",
          "hash",
        );
      } else {
  ...
  function len(obj) {
    ...
    try {
      ...
      throw _b_.TypeError.$factory(
        "object of type '" + $B.get_class(obj).__name__ + "' has no len()",
      );
    }
  }
  function locals() {
  ...
  function $extreme(args, op) {
    ...
    if (last_arg.$nat == "kw") {
      ...
      for (var attr in last_arg) {
        switch (attr) {
          ...
          default:
            throw _b_.TypeError.$factory(
              "'" + attr + "' is an invalid keyword argument for this function",
            );
        }
      }
    }
    ...
    if (nb_args == 0) {
      ...
      if (has_default) {
        throw _b_.TypeError.$factory(
          "Cannot specify a default for " + $op_name + "() with multiple positional arguments",
        );
      }
      var res = null;
  ...
  function ord(c) {
    ...
    switch ($B.get_class(c)) {
      ...
      case _b_.bytearray:
        ...
        throw _b_.TypeError.$factory(
          "ord() expected a character, but " + "string of length " + c.source.length + " found",
        );
      default:
        throw _b_.TypeError.$factory(
          "ord() expected a character, but " + $B.get_class(c).__name__ + " was found",
        );
    }
  }
  function pow() {
  ...
  function round(arg, n) {
    ...
    if (!isinstance(arg, [_b_.int, _b_.float])) {
      if (!hasattr(arg, "__round__"))
        throw _b_.TypeError.$factory("type " + arg.__class__ + " doesn't define __round__ method");
      if (n === undefined) {
    ...
    if (isinstance(arg, _b_.float)) {
      return _b_.float.$factory(
        _b_.int.__truediv__(Number(Math.round(arg.valueOf() * mult)), mult),
      );
    } else {
  ...
  $B.$setattr = function(obj, attr, value) {
    if ($B.aliased_names[attr]) {
      ...
      if (!value.__class__ === _b_.dict) {
        throw _b_.TypeError.$factory(
          "__dict__ must be set to a dictionary, " + "not a '" + value.__class__.__name + "'",
        );
      }
      for (var attr in obj) {
        if (attr !== "__class__") {
    ...
    if (klass && klass.$slots) {
      ...
      if (has_slots && slots[attr] === undefined) {
        throw _b_.AttributeError.$factory(
          "'" + klass.__name__ + "' object has no attribute '" + attr + "'",
        );
      }
    }
    var _setattr = false;
  ...
  var $$super = $B.make_class("super", function(_type1, _type2) {
    return { __class__: $$super, __thisclass__: _type1, __self_class__: _type2 };
  });
  ...
  function $url_open() {
    var $ns = $B.args(
        "open",
        3,
        { file: null, mode: null, encoding: null },
        ["file", "mode", "encoding"],
        arguments,
    ...
    if (isinstance(file, $B.JSObject)) {
      return $B.OpenFile.$factory(file.js, mode, encoding);
    }
  ...
  function no_set_attr(klass, attr) {
    if (klass[attr] !== undefined) {
      throw _b_.AttributeError.$factory(
        "'" + klass.__name__ + "' object attribute '" + attr + "' is read-only",
      );
    } else {
      throw _b_.AttributeError.$factory(
        "'" + klass.__name__ + "' object has no attribute '" + attr + "'",
    ...
    switch ($B.$comps[$key]) {
      ...
      case "lt":
        ellipsis["__" + $B.$comps[$key] + "__"] = (function(k) {
          return function(other) {
            throw _b_.TypeError.$factory(
              "unorderable types: ellipsis() " + k + " " + $B.get_class(other).__name__,
            );
          };
        })($key);
    }
...
(function($B) {
  ...
  var traceback = $B.make_class("traceback", function(exc, stack) {
    ...
    switch (attr) {
      ...
      case "tb_lineno":
        if (line_info === undefined) {
          ...
          return parseInt(line_info.split(",")[0]);
        }
      case "tb_lasti":
        if (line_info === undefined) {
          return "<unknown>";
      ...
      case "tb_next":
        if (self.$stack.length <= 2) {
          ...
          return traceback.$factory(self.exc, self.$stack.slice(0, self.$stack.length - 2));
        }
      default:
  ...
  BaseException.__str__ = function(self) {
    if (self.args.length > 0) return _b_.str.$factory(self.args[0]);
  ...
  function $make_exc(names, parent) {
    ...
    for (var i = 0; i < names.length; i++) {
      ...
      _str[pos++] =
        "_b_." + name + ".__mro__ = [_b_." + parent.__name__ + "].concat(parent.__mro__)";
  ...
  $make_exc(
    [
      ["StopIteration", "err.value = arguments[0]"],
      "ArithmeticError",
      "AssertionError",
      "AttributeError",
      "BufferError",
...
(function($B) {
  ...
  range.__getitem__ = function(self, rank) {
    ...
    if (
      ($B.gt(self.step, 0) && ($B.ge(res, self.stop) || $B.gt(self.start, res))) ||
  ...
  range.__next__ = function(self) {
    if (self.$safe) {
      ...
      if (
        ($B.gt(self.step, 0) && $B.ge(self.$counter, self.stop)) ||
  ...
  range.__reversed__ = function(self) {
    ...
    return range.$factory(
      $B.add(self.start, $B.mul(n, self.step)),
  ...
  range.index = function(self, other) {
    ...
    if ($B.eq(res, sub)) {
      if (
        ($B.gt(self.stop, self.start) && $B.ge(other, self.start) && $B.gt(self.stop, other)) ||
        ($B.ge(self.start, self.stop) && $B.ge(self.start, other) && $B.gt(other, self.stop))
      ) {
        return fl;
      } else {
        throw _b_.ValueError.$factory(_b_.str.$factory(other) + " not in range");
  ...
  slice.__repr__ = slice.__str__ = function(self) {
    return (
      "slice(" +
      _b_.str.$factory(self.start) +
      ", " +
      _b_.str.$factory(self.stop) +
      ", " +
      _b_.str.$factory(self.step) +
      ")"
    );
  };
...
(function($B) {
  ...
  bytearray.__setitem__ = function(self, arg, value) {
    if (isinstance(arg, _b_.int)) {
      ...
      throw _b_.TypeError.$factory(
        "list indices must be integer, not " + $B.get_class(arg).__name__,
      );
    }
  };
      ...
      if (isinstance(source, _b_.str)) {
        ...
        for (var i = 0; i < int_list.length; i++) {
          try {
            ...
            throw _b_.TypeError.$factory(
              "'" +
                $B.get_class(int_list[i]).__name__ +
                "' object " +
    ...
    if (!sub.__class__) {
      throw _b_.TypeError.$factory(
        "first argument must be a bytes-like " +
          "object, not '" +
          $B.get_class($.sub).__name__ +
          "'",
      );
    } else if (!sub.__class__.$buffer_protocol) {
      throw _b_.TypeError.$factory(
        "first argument must be a bytes-like " + "object, not '" + sub.__class__.__name__ + "'",
      );
    }
    var end =
      $.end == -1
        ? $.self.source.length - sub.source.length
  ...
  bytes.replace = function() {
    ...
    if (!$.old.__class__) {
      throw _b_.TypeError.$factory(
        "first argument must be a bytes-like " +
          "object, not '" +
          $B.get_class($.old).__name__ +
          "'",
      );
    } else if (!$.old.__class__.$buffer_protocol) {
      throw _b_.TypeError.$factory(
        "first argument must be a bytes-like " + "object, not '" + $.sep.__class__.__name__ + "'",
      );
    }
    if (!$.new.__class__) {
      throw _b_.TypeError.$factory(
      ...
      throw _b_.TypeError.$factory(
        "second argument must be a bytes-like " + "object, not '" + $.sep.__class__.__name__ + "'",
      );
    }
    for (var i = 0; i < len; i++) {
  ...
  bytes.split = function() {
    ...
    if (!$.sep.__class__) {
      throw _b_.TypeError.$factory(
        "a bytes-like object is required, " + "not '" + $B.get_class($.start).__name__ + "'",
      );
    } else if (!$.sep.__class__.$buffer_protocol) {
      throw _b_.TypeError.$factory(
        "a bytes-like object is required, " + "not '" + $.sep.__class__.__name_ + "'",
      );
    }
    var seps = $.sep.source,
      len = seps.length,
  ...
  bytes.startswith = function() {
    var $ = $B.args(
        "startswith",
        3,
        { self: null, prefix: null, start: null },
        ["self", "prefix", "start"],
        arguments,
        { start: 0 },
        null,
    ...
    if (_b_.isinstance($.prefix, bytes)) {
      ...
      throw _b_.TypeError.$factory(
        "startsswith first arg must be bytes " +
  ...
  bytes.translate = function(self, table, _delete) {
    if (_delete === undefined) {
      ...
      throw _b_.TypeError.$factory(
        "Type " + $B.get_class(_delete).__name + " doesn't support the buffer API",
      );
    }
    var res = [],
      pos = 0;
  ...
  function $UnicodeEncodeError(encoding, code_point, position) {
    throw _b_.UnicodeEncodeError.$factory(
      "'" +
        encoding +
  ...
  function $UnicodeDecodeError(encoding, position) {
    throw _b_.UnicodeDecodeError.$factory(
      "'" + encoding + "' codec can't decode bytes in position " + position,
    );
  }
  function _hex(_int) {
...
(function($B) {
        ...
        var res = function() {
          ...
          for (var i = 0, len = arguments.length; i < len; i++) {
            if (arguments[i] !== null && arguments[i].$nat !== undefined) {
              throw TypeError.$factory("A Javascript function can't take " + "keyword arguments");
            } else {
              args.push(pyobj2jsobj(arguments[i]));
            }
          }
  ...
  JSObject.__getitem__ = function(self, rank) {
    if (typeof self.js.length == "number") {
      if (
        (typeof rank == "number" || typeof rank == "boolean") &&
    ...
    try {
      return getattr(self.js, "__getitem__")(rank);
    } catch (err) {
          ...
          try {
            ...
            if (err.args.length > 0) {
              err.toString = function() {
                return info + "\n" + err.__class__.__name__ + ": " + _b_.repr(err.args[0]);
              };
            } else {
              err.toString = function() {
...
(function($B) {
  ...
  var pylist = [
    ...
    "signal",
    "site",
    "site-packages.__future__",
    "site-packages.docs",
    "site-packages.header",
    "site-packages.test_sp",
    "socket",
    "sre_compile",
    "sre_constants",
    "sre_parse",
...
(function($B) {
      ...
      if ($B.stdlib && $B.$options.static_stdlib_import) {
        ...
        if (address !== undefined) {
          var ext = address[0],
            ...
            path =
              $B.brython_path + (ext == "py" ? "Lib/" : "libs/") + fullname.replace(/\./g, "/"),
            metadata = {
              ext: ext,
              is_package: is_pkg,
      ...
      for (var i = 0, li = path.length; i < li; ++i) {
        ...
        if (finder === undefined) {
          ...
          for (var j = 0, lj = $B.path_hooks.length; j < lj && finder_notfound; ++j) {
            ...
            try {
              finder = (typeof hook == "function" ? hook : _b_.getattr(hook, "__call__"))(
                path_entry,
              );
        ...
        var find_spec = _b_.getattr(finder, "find_spec"),
          fs_func = typeof find_spec == "function" ? find_spec : _b_.getattr(find_spec, "__call__");
  ...
  var vfs_hook = {
    ...
    load_vfs: function(self) {
      try {
        var code = $download_module({ __name__: "<VFS>" }, self.path);
      } catch (e) {
        self.vfs = undefined;
  ...
  var url_hook = {
    ...
    __repr__: function(self) {
      return (
        "<UrlPathFinder" +
        (self.hint ? " for '" + self.hint + "'" : "(unbound)") +
        " at " +
        self.path_entry +
        ">"
      );
    ...
    find_spec: function(self, fullname, module) {
      ...
      if (tryall || hint == "pyc.js") {
        modpaths = modpaths.concat([
          [base_path + ".pyc.js", "pyc.js", false],
          [base_path + "/__init__.pyc.js", "pyc.js", true],
        ]);
      }
      if (tryall || hint == "py") {
        modpaths = modpaths.concat([
  ...
  $B.$__import__ = function(mod_name, globals, locals, fromlist, level) {
    ...
    if (modobj === undefined) {
      ...
      for (
        var i = 0, modsep = "", _mod_name = "", len = parsed_name.length - 1, __path__ = _b_.None;
        i <= len;
        ++i
      ) {
  ...
  $B.$import = function(mod_name, fromlist, aliases, locals) {
    ...
    var importer =
        typeof __import__ == "function" ? __import__ : _b_.getattr(__import__, "__call__"),
...
(function($B) {
  ...
  function preformat(self, fmt) {
    ...
    if (fmt.type && "eEfFgGn%".indexOf(fmt.type) == -1) {
      throw _b_.ValueError.$factory(
        "Unknown format code '" + fmt.type + "' for object of type 'float'",
      );
    }
    if (isNaN(self)) {
  ...
  float.__mul__ = function(self, other) {
    ...
    if (isinstance(other, _b_.complex)) {
      return $B.make_complex(
        float.$factory(self * other.$real),
  ...
  float.__truediv__ = function(self, other) {
    ...
    if (isinstance(other, _b_.complex)) {
      ...
      return $B.make_complex(
        float.$factory((self * other.$real) / cmod),
  ...
  var $notimplemented = function(self, other) {
    throw _b_.TypeError.$factory(
      "unsupported operand types for OPERATOR: 'float' and '" + $B.get_class(other).__name__ + "'",
    );
  };
  $notimplemented += "";
      ...
      switch (value.toLowerCase()) {
        ...
        default:
          ...
          if (isFinite(value)) return $FloatClass(eval(value));
            ...
            throw _b_.ValueError.$factory(
              "Could not convert to float(): '" + _b_.str.$factory(value) + "'",
            );
          }
      }
    }
...
(function($B) {
  ...
  int.to_bytes = function() {
    ...
    if (!_b_.isinstance(len, _b_.int)) {
      throw _b_.TypeError.$factory("integer argument expected, got " + $B.get_class(len).__name__);
    }
  ...
  int.__bool__ = function(self) {
    return new Boolean(self.valueOf());
  };
  ...
  int.__eq__ = function(self, other) {
    ...
    if (hasattr(other, "__eq__")) {
      return getattr(other, "__eq__")(self);
    }
  ...
  function preformat(self, fmt) {
    ...
    if (fmt.type && "bcdoxXn".indexOf(fmt.type) == -1) {
      throw _b_.ValueError.$factory(
        "Unknown format code '" + fmt.type + "' for object of type 'int'",
      );
    }
    var res;
    switch (fmt.type) {
  ...
  int.__lshift__ = function(self, other) {
    if (isinstance(other, int)) {
      return int.$factory(
        $B.long_int.__lshift__($B.long_int.$factory(self), $B.long_int.$factory(other)),
      );
    }
  ...
  int.__mod__ = function(self, other) {
    if (isinstance(other, _b_.tuple) && other.length == 1) {
      other = other[0];
    }
  ...
  int.__mul__ = function(self, other) {
    ...
    if (isinstance(other, int)) {
      ...
      if (res > $B.min_int && res < $B.max_int) {
        ...
        return int.$factory(
          $B.long_int.__mul__($B.long_int.$factory(self), $B.long_int.$factory(other)),
        );
      }
    }
    if (isinstance(other, _b_.float)) {
  ...
  int.__pow__ = function(self, other, z) {
    if (isinstance(other, int)) {
      ...
      if (res > $B.min_int && res < $B.max_int) {
        ...
        return int.$factory(
          $B.long_int.__pow__($B.long_int.$factory(self), $B.long_int.$factory(other)),
        );
      }
    }
    if (isinstance(other, _b_.float)) {
  ...
  int.__rshift__ = function(self, other) {
    if (isinstance(other, int)) {
      return int.$factory(
        $B.long_int.__rshift__($B.long_int.$factory(self), $B.long_int.$factory(other)),
      );
    }
  ...
  int.$factory = function(value, base) {
    ...
    if (typeof value == "string") {
      ...
      if (!_re.test(_value)) {
        throw _b_.ValueError.$factory(
          "invalid literal for int() with base " + base + ": '" + _b_.str.$factory(value) + "'",
        );
      }
    ...
    if (isinstance(value, [_b_.bytes, _b_.bytearray])) {
      ...
      for (var i = 0; i < value.source.length; i++) {
        if (_digits.indexOf(String.fromCharCode(value.source[i])) == -1) {
          throw _b_.ValueError.$factory(
            "invalid literal for int() with base " + base + ": " + _b_.repr(value),
          );
        }
      }
    ...
    if (hasattr(value, "__int__")) {
      return getattr(value, "__int__")();
    }
    if (hasattr(value, "__index__")) {
      return getattr(value, "__index__")();
    }
    if (hasattr(value, "__trunc__")) {
      ...
      if (int_func === null) {
        throw TypeError.$factory(
          "__trunc__ returned non-Integral (type " + $B.get_class(res).__name__ + ")",
        );
      }
      var res = int_func();
  ...
  bool.__le__ = function(self, other) {
    return !bool.__gt__(self, other);
  };
  bool.__lshift__ = function(self, other) {
    return self.valueOf() << other;
  };
  bool.__lt__ = function(self, other) {
    return !bool.__ge__(self, other);
  };
...
(function($B) {
  ...
  function check_shift(shift) {
    if (!isinstance(shift, long_int)) {
      throw TypeError.$factory("shift must be int, not '" + $B.get_class(shift).__name__ + "'");
    }
    if (!shift.pos) {
  ...
  long_int.__truediv__ = function(self, other) {
    if (isinstance(other, long_int)) {
      ...
      throw TypeError.$factory(
        "unsupported operand type(s) for /: 'int' and '" + $B.get_class(other).__name__ + "'",
      );
    }
  };
  ...
  long_int.$factory = function(value, base) {
    if (arguments.length > 2) {
      throw _b_.TypeError.$factory(
        "long_int takes at most 2 arguments (" + arguments.length + " given)",
      );
    }
    if (base === undefined) {
      base = 10;
      ...
      throw TypeError.$factory(
        "'" + $B.get_class(base).__name__ + "' object cannot be interpreted as an integer",
      );
    }
    ...
    if (typeof value == "number") {
      ...
      throw ValueError.$factory(
        "argument of long_int must be a string, not " + $B.get_class(value).__name__,
      );
    }
...
(function($B) {
  ...
  complex.__eq__ = function(self, other) {
    if (isinstance(other, complex)) {
      return (
        self.$real.valueOf() == other.$real.valueOf() &&
  ...
  complex.__new__ = function(cls) {
    ...
    if (
      (isinstance($real, _b_.float) || isinstance($real, _b_.int)) &&
      (isinstance($imag, _b_.float) || isinstance($imag, _b_.int))
    ) {
      res = { __class__: complex, $real: $real, $imag: $imag };
      return res;
    }
    ...
    $imag = _convert($imag);
    if (
      !isinstance($real, _b_.float) &&
      !isinstance($real, _b_.int) &&
    ...
    if (
      !isinstance($imag, _b_.float) &&
      !isinstance($imag, _b_.int) &&
      !isinstance($imag, _b_.complex) &&
      $imag !== undefined
    ) {
      throw _b_.TypeError.$factory("complex() argument must be a string " + "or a number");
    }
...
(function($B) {
  ...
  POWERS_OF_TEN = [1, 1e1, 1e2, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9];
  function log10(x) {
    if (x < 1e5) {
      if (x < 1e2) {
        return x < 1e1 ? 0 : 1;
  ...
  TimSort = function(array, compare) {
    self = {
      ...
      mergeHigh: function(start1, length1, start2, length2) {
        ...
        while (true) {
          ...
          do {
            count1 =
              length1 - gallopRight(tmp[cursor2], array, start1, length1, length1 - 1, compare);
            if (count1 !== 0) {
              dest -= count1;
              cursor1 -= count1;
              length1 -= count1;
    ...
    self.stackLength =
      self.length < 120 ? 5 : self.length < 1542 ? 10 : self.length < 119151 ? 19 : 40;
...
(function($B) {
  ...
  list.__add__ = function(self, other) {
    if ($B.get_class(self) !== $B.get_class(other)) {
      ...
      if (radd !== NotImplemented) {
        return radd(self);
      }
      throw TypeError.$factory(
        'can only concatenate list (not "' + $B.get_class(other).__name__ + '") to list',
      );
    }
  ...
  list.__delitem__ = function(self, arg) {
    ...
    throw _b_.TypeError.$factory(
      "list indices must be integer, not " + _b_.str.$factory(arg.__class__),
    );
  };
  ...
  list.__ge__ = function(self, other) {
    if (!isinstance(other, [list, _b_.tuple])) {
      throw _b_.TypeError.$factory(
        "unorderable types: list() >= " + $B.get_class(other).__name__ + "()",
      );
    }
    var i = 0;
    while (i < self.length) {
  ...
  list.__mul__ = function(self, other) {
    ...
    throw _b_.TypeError.$factory(
      "can't multiply sequence by non-int of type '" + $B.get_class(other).__name__ + "'",
    );
  };
  ...
  list.index = function() {
    var $ = $B.args(
        "index",
        4,
        { self: null, x: null, start: null, stop: null },
        ["self", "x", "start", "stop"],
        arguments,
  ...
  list.sort = function(self) {
    ...
    for (var i = 0; i < keys.length; i++) {
      if (keys[i] == "key") {
        ...
        throw _b_.TypeError.$factory(
          "'" + keys[i] + "' is an invalid keyword argument for this function",
        );
      }
    }
    if (self.length == 0) {
...
(function($B) {
  ...
  function check_str(obj) {
    if (!_b_.isinstance(obj, str)) {
      throw _b_.TypeError.$factory(
        "can't convert '" + $B.get_class(obj).__name__ + "' object to str implicitly",
      );
    }
  }
  str.__add__ = function(self, other) {
    if (!(typeof other === "string")) {
      try {
        ...
        throw _b_.TypeError.$factory(
          "Can't convert " + $B.get_class(other).__name__ + " to str implicitly",
        );
      }
    }
    return self + other;
  ...
  function preformat(self, fmt) {
    ...
    if (fmt.type && fmt.type != "s") {
      throw _b_.ValueError.$factory(
        "Unknown format code '" + fmt.type + "' for object of type 'str'",
      );
    }
    return self;
  }
  ...
  str.__hash__ = function(self) {
    if (self === undefined) {
      return str.__hashvalue__ || $B.$py_next_hash--;
    }
    var hash = 1;
    for (var i = 0, len = self.length; i < len; i++) {
  ...
  var floating_point_format = function(val, upper, flags) {
    ...
    if (val < 1 && val > -1) {
      ...
      if (numzeros >= 4) {
        val =
          ...
          format_float_precision(val, upper, flags, _floating_g_exp_helper);
        if (!flags.alternate) {
      ...
      return format_padding(
        format_sign(val, flags) +
          format_float_precision(val, upper, flags, function(val, precision) {
    ...
    if (dot_idx > flags.precision) {
      val =
        format_sign(val, flags) + format_float_precision(val, upper, flags, _floating_g_exp_helper);
      if (!flags.alternate) {
        var trl = trailing_zeros.exec(val);
        if (trl) {
          val = trl[1].replace(trailing_dot, "") + trl[3];
  ...
  var floating_point_exponential_format = function(val, upper, flags) {
    val = _float_helper(val, flags);
    return format_padding(
      format_sign(val, flags) + format_float_precision(val, upper, flags, _floating_exp_helper),
      flags,
    );
  };
          ...
          if (err.name == "UnsupportedChar") {
            ...
            throw _b_.ValueError.$factory(
              "unsupported format character '" +
                invalid_char +
                "' (0x" +
                invalid_char.charCodeAt(0).toString(16) +
                ") at index " +
                newpos,
            );
            ...
            throw _b_.TypeError.$factory(
              "%" + try_char + " format: a number is required, not " + cls,
            );
          } else {
            throw err;
          }
  ...
  str.count = function() {
    var $ = $B.args(
      "count",
      4,
      { self: null, sub: null, start: null, stop: null },
      ["self", "sub", "start", "stop"],
      arguments,
      { start: null, stop: null },
      null,
  ...
  str.format = function(self) {
    var $ = $B.args("format", 1, { self: null }, ["self"], arguments, {}, "$args", "$kw");
    var pos = 0,
      _len = self.length,
      car,
      text = "",
  ...
  str.replace = function(self, old, _new, count) {
    ...
    if (!isinstance(count, [_b_.int, _b_.float])) {
      throw _b_.TypeError.$factory(
        "'" + $B.get_class(count).__name__ + "' object cannot be interpreted as an integer",
      );
  ...
  str.rsplit = function(self) {
    var $ = $B.args(
        "rsplit",
        3,
        { self: null, sep: null, maxsplit: null },
        ["self", "sep", "maxsplit"],
        arguments,
  ...
  str.splitlines = function(self) {
    ...
    if (!_b_.isinstance($.keepends, [_b_.bool, _b_.int])) {
      throw _b_.TypeError.$factory(
        "integer argument expected, got " + $B.get_class($.keepends).__name,
      );
    }
  ...
  str.translate = function(self, table) {
    ...
    if (isinstance(table, _b_.dict)) {
      for (var i = 0, len = self.length; i < len; i++) {
        ...
        if (repl == -1) {
          res[pos++] = self.charAt(i);
        } else if (repl !== None) {
          res[pos++] = _b_.chr(repl);
        }
      }
    }
    return res.join("");
  ...
  $B.parse_format_spec = function(spec) {
    ...
    this.toString = function() {
      return (
        (this.fill === undefined ? "" : _b_.str.$factory(this.fill)) +
        (this.align || "") +
        (this.sign || "") +
        (this.alternate ? "#" : "") +
        (this.sign_aware ? "0" : "") +
...
(function($B) {
  ...
  dict.__eq__ = function() {
    ...
    if (
      self.$numeric_dict.length != other.$numeric_dict.length ||
  ...
  dict.get = function() {
    var $ = $B.args(
      "get",
      3,
      { self: null, key: null, _default: null },
      ["self", "key", "_default"],
      arguments,
      { _default: $N },
      null,
...
(function($B) {
  ...
  set.__add__ = function(self, other) {
    throw _b_.TypeError.$factory("unsupported operand type(s) for +: 'set' and " + typeof other);
  };
  ...
  set.__lt__ = function(self, other) {
    if (_b_.isinstance(other, [set, frozenset])) {
      ...
      return _b_.object["__lt__"](self, other);
    }
  };
  ...
  eval(
    "set.intersection = " + fc.replace(/difference/g, "intersection").replace("__sub__", "__and__"),
  );
  eval(
...
(function($B) {
  ...
  function $EventsList(elt, evt, arg) {
    ...
    this.remove = function(callback) {
      ...
      if (!found) {
        throw KeyError.$factory("not found");
      }
    };
  }
  ...
  DOMNode.__add__ = function(self, other) {
    ...
    if (isinstance(other, TagSum)) {
      ...
      isinstance(other, [_b_.str, _b_.int, _b_.float, _b_.list, _b_.dict, _b_.set, _b_.tuple])
    ) {
      ...
      try {
        ...
        throw _b_.TypeError.$factory(
          "can't add '" + $B.get_class(other).__name__ + "' object to DOMNode instance",
        );
      }
    }
    return res;
  ...
  DOMNode.__getattribute__ = function(self, attr) {
    ...
    switch (attr) {
      ...
      case "width":
        ...
        if (self.elt.style[attr]) {
          ...
          throw _b_.AttributeError.$factory(
            "style." + attr + " is not set for " + str.$factory(self),
          );
        }
      case "clear":
      case "closest":
    ...
    if (res !== undefined) {
      ...
      if (attr == "style") {
        return Style.$factory(self.elt[attr]);
      }
  ...
  DOMNode.set_value = function(self, value) {
    self.elt.value = str.$factory(value);
  };
  ...
  TagSum.__add__ = function(self, other) {
    ...
    } else if (isinstance(other, [_b_.str, _b_.int, _b_.float, _b_.dict, _b_.set, _b_.list])) {
...
(function($B) {
  ...
  function make_node(top_node, node) {
    ...
    if (node.C.$genjs) {
      var ctx_js = node.C.$genjs;
    } else {
      var ctx_js = (node.C.$genjs = node.C.to_js());
    }
    var is_cond = false,
      is_except = false,
      is_else = false,
    ...
    if (ctx_js) {
      ...
      if (ctype == "yield") {
        ...
        js += "if(sent_value.__class__ === $B.$GeneratorSendError)" + "{throw sent_value.err}";
  ...
  function make_next(self, yield_node_id) {
    ...
    while (1) {
      ...
      if (exit_node.loop_start !== undefined) {
        ...
        while (
          start < exit_parent.children.length &&
          (exit_parent.children[start].is_except || exit_parent.children[start].is_else)
        ) {
          start++;
        }
  ...
  generator.$$throw = function(self, value) {
    if (_b_.isinstance(value, _b_.type)) {
      value = value();
    }
...
(function($B) {
      ...
      bind: function() {
        ...
        return function(callback) {
          if (_b_.isinstance($.elt, $B.DOMNode)) {
            ...
            for (var i = 0; i < items.length; i++) {
              $B.DOMNode.bind($B.DOMNode.$factory(items[i]), $.evt, callback);
            }
            return callback;
          }
          try {
  ...
  modules["javascript"] = {
    ...
    JSObject: function() {
      console.log('"javascript.JSObject" is deprecrated. ' + "Use window.<jsobject name> instead.");
